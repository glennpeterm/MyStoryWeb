...
<div class="content_wrapper">
    ...
    <div class="search_title_holder">
    	<div class="search_title"><?php echo lang('search_title_common');?>  <span>"<?php echo $keyword;?>"</span></div>
         <?php
         if($result_count>0){
          ?>
        ...
        <div class="search_video_list" onclick="assignId(<?php echo  $results->video_id ;?>)">
        	<div><img src="https://i.ytimg.com/vi/<?php echo $results->video_youtube_id;?>/sddefault.jpg"></div>
               <div class="vdetails">
                    ...
                    <p><?php echo substr($results->video_short_desc ,0,50);if(strlen($results->video_short_desc )>50) {?> .....<?php }?></p>
                </div>
          </div>
        <?php } }else{?>
