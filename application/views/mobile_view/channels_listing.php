...
<!--    <div class="filter_form_holder"><select style="width:100%"></select></div>-->
    <div class="filter_form_holder">
      <div class="halfborder">
            <div class="textareaKeeper"><input id="keyword" style="overflow:hidden; border :0px; background:none; margin-top:-0px; font-family: 'Abel', sans-serif;" onkeyup="keywordserach();" placeholder="Search keyword" /></div>
        </div>  
           ...
           if( ! loading ){
            ...
            $.ajax({
              ...
              success:function(data){                                                                
                ...
                var data  = $.parseJSON(data);
                                                                $(data.html).hide().appendTo('.contaier_list_holder').delay(500).fadeIn(2000);
                                                          current_page++;               
