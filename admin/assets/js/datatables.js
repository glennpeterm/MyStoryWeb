...
function initDatatables() {
	...
	function fnFormatDetails(oTable, nTr) {
		...
		var sOut = '<table cellpadding="5" cellspacing="0" border="0" class="detail-row">';
			...
			sOut += '<tr><td>Email</td><td>:</td><td>'+aData[2]+'</td></tr>';
			sOut += '<tr><td>Message</td><td>:</td><td>'+aData[3]+'</td></tr>';
                        sOut += '<tr><td>Date</td><td>:</td><td>'+aData[4]+'</td></tr>';
			sOut += '</table>';
