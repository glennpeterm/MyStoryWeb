				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="grid">
							...
							<div class="grid-body">
                                                                  <form class="form-horizontal" role="form" action="<?php echo base_url();?>adminusers/chnagepassword" method="POST"  >
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="old_password" name="old_password" placeholder="Old Password" value="<?php echo isset($title) ? $title : set_value("old_password") ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="new_password" name="new_password" placeholder="New Password" value="<?php echo isset($title) ? $title : set_value("new_password") ?>">
										...
										<div class="col-sm-7">
                                                                                    <input type="text" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password" value="<?php echo isset($title) ? $title : set_value("confirm_password") ?>">
