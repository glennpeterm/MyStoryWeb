				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="account-wall">
							...
							<!-- BEGIN REGISTER FORM -->
							<form name="register" action="<?php echo base_url();?>users/passwordResetAction" method="post" class="form-login" role="form">
								   
                                                                  <input type="hidden" value="<?php echo $activation_token;?>" name="activation_token">                                                           
                                                                <input type="password" id="password"  name="password" class="form-control" placeholder="New Password" value="<?php echo isset($password) ? $password : set_value("password") ?>">
