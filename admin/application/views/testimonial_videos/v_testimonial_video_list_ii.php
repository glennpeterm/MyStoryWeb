						...
						<div class="grid no-border">
							<div class="grid-header">
								...
								<span class="grid-title"><?php echo lang('listing');?></span>
                                                     ...
                                                     <a href="<?php echo site_url("testimonial_videos/add"); ?>"><button style="float:right"type="button" class="btn btn-primary"><?php echo lang('common_add');?></button></a>
							<div class="grid-body">
								<table id="dataTables1" class="table table-hover display" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr id="<?php echo $results->testvideo_id;?>" >
                                                                                <td><?php echo $results->testvideo_title ;?> </td>
                                                                                <td>
                                                                                    
                                                                                    <?php echo substr($results->testvideo_desc,0,30);if(strlen($results->testvideo_desc)>30) {?> .....<?php }?>
                                                                                </td>
                                                                                <td><?php echo $results->testvideo_added_date;?></td>
                                                                                
                                                                                <?php 
                                                                                        
                                                                                $statusChecked = '';
                                                                                if(isset($results->testvideo_status) && ($results->testvideo_status == 1)){
                                                                                    $statusChecked = ' checked';
                                                                                }
                                                                                    ?>
                                                                                <td>
                                                                                      <span style="display:none;"><?=$results->testvideo_id;?></span>
                                                                                    <input type="checkbox" class="js-switch xsmall" id="<?php echo $results->testvideo_id;?>" <?php echo $statusChecked;?> onchange="changeStatus(<?php echo $results->testvideo_id;?>,'<?php echo $results->testvideo_status;?>')"/></td>	
                                                                                   
                                                                                <td>                                                           
                                                                                    <a href="<?php echo base_url();?>testimonial_videos/view/<?php echo $results->testvideo_id;?>" title="<?=lang('txt_view');?>"  >
                                                                                    <li class="fa fa-eye bg-yellow action"></li>
                                                                                    </a>
                                                                                    <a href="<?php echo base_url();?>testimonial_videos/add/<?php echo $results->testvideo_id;?>" title="<?=lang('txt_edit');?>"  >
                                                                                    <li class="fa fa-pencil bg-blue action"></li> 
                                                                                    </a>
                                                                                    <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $results->testvideo_id;?>)" title="<?=lang('txt_delete');?>"  >
