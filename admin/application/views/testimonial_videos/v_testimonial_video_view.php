				...
				<div class="grid-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                      ...
                                      <!--<p class="col-lg-6 no-padding"><strong><?php echo lang('video_title');?> :</strong><span> <?php echo $video_title;?></span></p>-->
                                        <p class="col-lg-12 no-padding"><strong><?php echo lang('video_desc');?> :</strong> <?php echo $video_desc;?></p>
                                        ...
                                        <p class="col-lg-6 no-padding"><strong><?php echo lang('txt_status');?>:</strong><span><?php if($video_status==1) 
                                                                                        {
                                                                                            $status= 'Active';
                                                                                        }
                                                                                        else {
                        ...
                        <div class="btn-toolbar">
                            <div class="btn-group">
                                ...
                                <a href="<?php echo $cancel_url; ?>"><button type="button" class="btn btn-info"><?php echo lang('back');?></button></a>
                                     ...
                                     <a href="<?php echo base_url();?>testimonial_videos/add/<?php echo $video_id;?>"><button style="margin-left: 10px;"type="button" class="btn btn-success"><?php echo lang('txt_edit');?></button></a>
                            </div>
                    </div>
                    <div class="clear"></div>
                    </div>
