...
?>
		<aside class="right-side">
			...
			<section class="content-header">
				...
				<span><?php echo lang('add_scripture_video');?></span>
				<ol class="breadcrumb">
                                        ...
                                        if($chapter_array!=''){?>
                                            <div class="form-group">
                                                      <label class="col-sm-3 control-label"> <?php echo lang('chapter');?></label>
                                                       ...
                                                       <span style="color:red"> <?php echo form_error('chapterno'); ?></span>
                                         ...
                                         if($verse_array!=''){?>
                                                <div class="form-group">
                                                   ...
                                                   <select class='form-control verseno' name="verseno" onchange='showtext(this);'>
                                                     ...
                                                     <span style="color:red"> <?php echo form_error('verseno'); ?></span>
...
<!--                                   <input type="hidden" name="chapterno" id="chapterno" >
                                ...
                                <div class="form-group"  id="verse_div" >
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-7">
                                        <input type="text" class="form-control" id="video_id" name="video_id" placeholder="<?php echo lang('video_id');?>" value="<?php echo isset($video_id) ? $video_id : set_value("video_id") ?>"> <p style="margin:8px 0px;">Eg : <img src="<?php echo base_url();?>assets/img/video_id_eg.png"></p>
                                        <span style="color:red"> <?php echo form_error('video_id'); ?></span>
                                        <?php  if(isset($youtube_error)){?> <span style="color:red"> <?php echo $youtube_error; ?></span>  <?php }?>                                        
									...
									<div class="form-group">
										<div class="col-sm-offset-4 col-sm-10">
											...
											<div class="btn-group">
                                                                                             <input type="submit"  id="submit"  name="submit" value="<?php echo lang('save');?>" class="btn btn-primary" />
												
												 <a href="<?php echo site_url("scripture_videos"); ?>"><button style="margin-left: 10px;"type="button" class="btn  btn-warning"><?php echo lang('cancel');?></button></a>
											</div>
                                                                                </div>
										</div>
