							...
							<div class="grid-body">
								<table id="dataTables1" class="table table-hover display" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr id="<?php echo $results->scripture_video_user_share_id;?>" >
                                                                                <td><?php echo $results->first_name ;?> </td> 
                                                                                <td><?php echo $results->script_video_url ;?> </td>                                                                                 
                                                                                <td><?php echo $results->scripture_video_user_share_added_date ;?> </td>   
