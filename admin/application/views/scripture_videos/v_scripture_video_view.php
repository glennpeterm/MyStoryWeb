                                        ...
                                        <div class="btn-toolbar"
                                            <div class="btn-group">
                                                ...
                                                <a href="<?php echo $cancel_url; ?>"><button type="button" class="btn btn-info"><?php echo lang('back');?></button></a>
                                                     ...
                                                     <a href="<?php echo base_url();?>scripture_videos/add/<?php echo $video_id;?>"><button style="margin-left: 10px;"type="button" class="btn btn-success"><?php echo lang('txt_edit');?></button></a>
                                            </div>
                                    </div>
                                    </div>             
                              </div>    
