...
<?php echo $menu;?><aside class="right-side">
			...
			<section class="content-header">
				...
				<span><?php echo lang('scripture_videos');?></span>
				<ol class="breadcrumb">
					<li><a href="<?=site_url('home');?>"><?php echo lang('home');?></a></li>
                                        <li class="active"><?=lang('scripture_video_list');?></li>                                     
						...
						<div class="grid no-border">
							<div class="grid-header">
								...
								<span class="grid-title"><?php echo lang('listing');?></span>
								 <a href="<?php echo site_url("scripture_videos/add"); ?>"><button style="float:right"type="button" class="btn btn-primary"><?php echo lang('add');?></button></a>
							</div>
							...
							<div class="grid-body">
								<table id="dataTables1" class="table table-hover display" cellspacing="0" width="100%">
									...
									<tbody>
                                                                           ...
                                                                           if(isset($scripture_details))
                                                                                { 
                                                                                 
                                                                                    foreach ($scripture_details as $results):?>
										...
										<tr id="<?php echo $results->video_id;?>" >
                                                                                ...
                                                                                <td>
                                                                                    <a href="<?php echo base_url();?>scripture_videos/view/<?php echo $results->video_id;?>" title="<?=lang('txt_view');?>" >
                                                                                    <li class="fa fa-eye bg-yellow action"></li>
                                                                                    </a>
                                                                                    <a href="<?php echo base_url();?>scripture_videos/add/<?php echo $results->video_id;?>" title="<?=lang('txt_edit');?>" >
         ...
         <script>
            ...
            function confirmDelete(id) {
              if (confirm(delete_confirmation)) {
                   ...
                   window.location = baseurl+'scripture_videos/delete/'+id;
 ...
 <script>
    // changing video status
        function changeStatus(chkid,chkstatus)
        {
           ...
           $.ajax({
               url: baseurl+'scripture_videos/setstatus',
               type: 'POST', 
