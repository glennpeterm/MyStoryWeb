				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="grid">
							...
							<div class="grid-body">
                                                                  <form class="form-horizontal" role="form" action="<?php echo base_url();?>selfie_videos/add/<?php echo $id;?>" method="POST" onsubmit="return form_err_chk()" >
                                    ...
                                    <?php 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                             ...
                                             <select class="form-control" id="country" name="country" >
                                              ...
                                              <?php foreach ($countries as $results)
                                                 { 
                                                  if($results->name == $country)
                                                   {
                                                       $sel= 'selected="selected"';
                                                    }
                                                    else 
                                                ...
                                                <option <?php echo $sel ;?>value="<?php echo $results->name;?>"><?php echo $results->name;?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                              ...
                                              <?php foreach ($languages as $results)
                                                 { 

                                                  if($results->code ==$language_name)
                                                   {
                                                       $sel= 'selected="selected"';
                                                    }
                                                    else 
                                                ...
                                                <option <?php echo $sel ;?>value="<?php echo $results->code;?>"><?php echo $results->language;?></option>
                                                
                                                  <?php } ?>
                                            </select>

                                               <span style="color:red"> <?php echo form_error('language'); ?></span>
                                            </div>
                                        </div>
										...
										<br>
                                                                        ...
                                                                        <div class="form-group">
										<label class="col-sm-3 control-label"><?php echo lang('web_status');?></label>
										<div class="col-sm-7">
                                                                                    <?php
                      ...
                      <input hidden="radio" name="prev_status"  value="<?php echo $video_status;?>" >
