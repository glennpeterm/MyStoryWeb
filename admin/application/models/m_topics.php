...
Class M_Topics extends CI_Model
{
    ...
    function saveDetails($datas)
    {
        $insert_data = array(                                                
                    ...
                    'topic_title'       => $datas['topic_title'], 
                    'topic_link'        => $datas['topic_link'], 
                    'topic_status'      => $datas['topic_status'],       
    ...
    {
        $this->db->where('topic_id', $id)->delete('video_topic_relation');
    ...
    function topicAlreadyExist($topicanme,$language,$role,$topicid)
    {
       //$topicname = strtolower($topicanme);
        ...
        $this->db->where(array('LOWER(topic_name)'=>$topicanme,'topic_id !='=> $topicid));        
     ...
     // function for setting  topic status
    public function setStatus()
    {                
       $upDdata = array();
       $upDdata['topic_status'] = $this->input->post('status'); 
       $this->db->update('topic', $upDdata, array('topic_id' => $this->input->post('id')));   
       return true;
    }
    // End of function for setting  topic status
}   
